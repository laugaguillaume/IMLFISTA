...
y = physics(x_true)
psnr_y = perf_psnr(x_true, y).item()
yML = y.clone()
...
titles = ['original', f'observation\nPSNR: {psnrs_formatted[0]} dB', f'MLCGDCD (param_regul = {param_regularization})\nPSNR: {psnrs_formatted[1]} dB']

dinv.utils.plot([x_true, y, x_mlcgdcd], titles=titles)
